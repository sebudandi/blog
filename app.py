...
from insertdata import db_execute_fetch
...
def main():
    """a simple crud app"""
    st.title("Day 5")
    menu = ["Charts", "View Hashtags", "Localize tweets"]
    ...
    elif choice == "View Hashtags":
        st.subheader("View Hashtags")
        selectHashTag()

    elif choice == "Localize tweets":

        st.subheader("Localize tweets")
        selectLocAndAuth()
